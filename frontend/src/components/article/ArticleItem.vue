    ...
    <div class="article-item">
        <router-link :to="{ name: 'articleById', params: { id: article.id } }">
            <div class="article-item-image d-none d-sm-block">
                <img v-if="article.imageUrl" class="img-fit" :src="article.imageUrl" height="150" width="150" alt="Article">
                <img v-else class="img-fit" src="@/assets/perfect.gif" height="150" width="150" alt="Article">
            </div>
